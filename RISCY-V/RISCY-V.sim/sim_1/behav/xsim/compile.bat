...
REM
REM Generated by Vivado on Mon Aug 03 12:15:50 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj RISC_V_wrapper_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj RISC_V_wrapper_tb_vlog.prj -log xvlog.log
