...
#
# Script generated by Vivado on Mon Aug 03 12:15:44 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RISC_V_wrapper_tb.sh
...
#
# Usage        : RISC_V_wrapper_tb.sh
#                RISC_V_wrapper_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RISC_V_wrapper_tb.sh [-rerun]
#                RISC_V_wrapper_tb.sh [-reset_run]
#                RISC_V_wrapper_tb.sh [-clean]
#                RISC_V_wrapper_tb.sh [-reset_log]
#                RISC_V_wrapper_tb.sh [-help]
#
...
# script info
echo -e "RISC_V_wrapper_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RISC_V_wrapper_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot RISC_V_wrapper_tb xil_defaultlib.RISC_V_wrapper_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RISC_V_wrapper_tb -key {Behavioral:sim_1:Functional:RISC_V_wrapper_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/RISC_V.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RISC_V_wrapper_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RISC_V_wrapper_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RISC_V_wrapper_tb.sh [-help]\n\
Usage: RISC_V_wrapper_tb.sh [-step]\n\
Usage: RISC_V_wrapper_tb.sh [-lib_map_path]\n\
Usage: RISC_V_wrapper_tb.sh [-rerun]\n\
Usage: RISC_V_wrapper_tb.sh [-reset_run]\n\
Usage: RISC_V_wrapper_tb.sh [-clean]\n\
Usage: RISC_V_wrapper_tb.sh [-reset_log]\n\
Usage: RISC_V_wrapper_tb.sh [-keep_index]\n\
Usage: RISC_V_wrapper_tb.sh [-noclean_files]\n\n\
