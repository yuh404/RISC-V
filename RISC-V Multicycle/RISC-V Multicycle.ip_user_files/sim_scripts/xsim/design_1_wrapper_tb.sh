...
#
# Script generated by Vivado on Thu Aug 06 11:26:03 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_1_wrapper_tb.sh
...
#
# Usage        : design_1_wrapper_tb.sh
#                design_1_wrapper_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_1_wrapper_tb.sh [-rerun]
#                design_1_wrapper_tb.sh [-reset_run]
#                design_1_wrapper_tb.sh [-clean]
#                design_1_wrapper_tb.sh [-reset_log]
#                design_1_wrapper_tb.sh [-help]
#
...
# script info
echo -e "design_1_wrapper_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_1_wrapper_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L proc_sys_reset_v5_0_17 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1_wrapper_tb xil_defaultlib.design_1_wrapper_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1_wrapper_tb -key {Behavioral:sim_1:Functional:design_1_wrapper_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/SoC/2025.2/Vivado/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm proc_sys_reset_v5_0_17)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_1_wrapper_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_1_wrapper_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_1_wrapper_tb.sh [-help]\n\
Usage: design_1_wrapper_tb.sh [-step]\n\
Usage: design_1_wrapper_tb.sh [-lib_map_path]\n\
Usage: design_1_wrapper_tb.sh [-rerun]\n\
Usage: design_1_wrapper_tb.sh [-reset_run]\n\
Usage: design_1_wrapper_tb.sh [-clean]\n\
Usage: design_1_wrapper_tb.sh [-reset_log]\n\
Usage: design_1_wrapper_tb.sh [-keep_index]\n\
Usage: design_1_wrapper_tb.sh [-noclean_files]\n\n\
