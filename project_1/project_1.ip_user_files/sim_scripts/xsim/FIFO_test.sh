...
#
# Script generated by Vivado on Sat Jun 27 14:10:53 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FIFO_test.sh
...
#
# Usage        : FIFO_test.sh
#                FIFO_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIFO_test.sh [-rerun]
#                FIFO_test.sh [-reset_run]
#                FIFO_test.sh [-clean]
#                FIFO_test.sh [-reset_log]
#                FIFO_test.sh [-help]
#
...
# script info
echo -e "FIFO_test.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIFO_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot FIFO_test xil_defaultlib.FIFO_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FIFO_test -key {Behavioral:sim_1:Functional:FIFO_test} -tclbatch cmd.tcl -protoinst "protoinst_files/design_3.protoinst" -protoinst "protoinst_files/design_FIFO_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FIFO_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FIFO_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FIFO_test.sh [-help]\n\
Usage: FIFO_test.sh [-step]\n\
Usage: FIFO_test.sh [-lib_map_path]\n\
Usage: FIFO_test.sh [-rerun]\n\
Usage: FIFO_test.sh [-reset_run]\n\
Usage: FIFO_test.sh [-clean]\n\
Usage: FIFO_test.sh [-reset_log]\n\
Usage: FIFO_test.sh [-keep_index]\n\
Usage: FIFO_test.sh [-noclean_files]\n\n\
