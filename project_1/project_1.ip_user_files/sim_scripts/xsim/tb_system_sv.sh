...
#
# Script generated by Vivado on Fri Jul 03 23:10:14 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_system_sv.sh
...
#
# Usage        : tb_system_sv.sh
#                tb_system_sv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_system_sv.sh [-rerun]
#                tb_system_sv.sh [-reset_run]
#                tb_system_sv.sh [-clean]
#                tb_system_sv.sh [-reset_log]
#                tb_system_sv.sh [-help]
#
...
# script info
echo -e "tb_system_sv.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_system_sv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_system_sv xil_defaultlib.tb_system_sv xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_system_sv -key {Behavioral:sim_1:Functional:tb_system_sv} -tclbatch cmd.tcl -protoinst "protoinst_files/design_FIFO_test.protoinst" -protoinst "protoinst_files/design_3.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_system_sv.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_system_sv.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_system_sv.sh [-help]\n\
Usage: tb_system_sv.sh [-step]\n\
Usage: tb_system_sv.sh [-lib_map_path]\n\
Usage: tb_system_sv.sh [-rerun]\n\
Usage: tb_system_sv.sh [-reset_run]\n\
Usage: tb_system_sv.sh [-clean]\n\
Usage: tb_system_sv.sh [-reset_log]\n\
Usage: tb_system_sv.sh [-keep_index]\n\
Usage: tb_system_sv.sh [-noclean_files]\n\n\
