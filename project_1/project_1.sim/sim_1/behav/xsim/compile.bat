...
REM
REM Generated by Vivado on Fri Jul 03 23:10:22 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_system_sv_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_system_sv_vlog.prj -log xvlog.log
